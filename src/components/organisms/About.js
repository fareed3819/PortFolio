...
const useStyles = makeStyles((theme) => ({
    title: { fontStyle: 'italic', textAlign: 'left', fontWeight: 900, color: 'white', marginBottom: 20, marginLeft: 20, marginTop: '100px' },
    content: { display: 'flex', flexDirection: 'row', width: 800, color: 'white' },
